...
<head>
    ...
    <?php echo css( 'stylesheets/css/56.css') ?>
    <script src="//ajax.googleapis.com/ajax/libs/jquery/1.8.2/jquery.min.js"></script>
    <?php echo "<script type='text/javascript' src='bower_components/jquery.bxslider/jquery.bxslider.min.js'></script>"; ?>
    <?php echo css( 'bower_components/jquery.bxslider/jquery.bxslider.css') ?>
    <script>
        // jsgl.js
        ...
        jsgl = (function () {
            ...
            function invertNormalized(a) {
                ...
                var trans_prime = transformPoint(m, {
                    x: a.e12,
                    y: a.e13,
                    z: a.e14
                });
            ...
            function orthonormalizeRotation(a) {
                var new_x = vectorNormalize({
                    x: a.e0,
                    y: a.e1,
                    z: a.e2
                });
                var new_z = vectorNormalize(crossProduct(new_x, {
                    x: a.e4,
                    y: a.e5,
                    z: a.e6
                }));
    ...
    <script>
        ...
        function init() {
            canvas_elem = document.getElementById('canvas1');
        ...
        window.addEventListener('load', function () {
            ...
            images[0].src = 'assets/images/header/cerealcropped.png';
        }, false);
    </script>
...
<body onkeydown="return keydown(event);" onkeyup="return keyup(event);">
    ...
    <a class="logo" href="<?php echo url() ?>">
      <img src="<?php echo url('assets/images/logo-black.png') ?>" alt="<?php echo $site->title()->html() ?>" />
    </a>
    <?php snippet('menu') ?>
  </header> -->