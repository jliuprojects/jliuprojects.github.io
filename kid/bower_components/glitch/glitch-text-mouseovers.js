...
function glitchAllMouseover(x,skipSpace) {
...
function glitchAllSameMouseover(x,skipSpace) {
...
function glitchAllPreciseMouseover(x, charNum,skipSpace) {
...
function randomizeTextMouseover(x,skipSpace) {
...
function randomizeInRangeMouseover(x, startRange, endRange,skipSpace) {
...
function randomizeBlockMouseover(x, blockName,skipSpace) {
    ...
    for (var i = textLength - 1; i >= 0; i -= 1) {
        ...
        if (skipSpace == true) {
            if (letter == " ") {
                glitching = glitching.replaceAt(i, 0, ' ');
            } else {
                randomChar = randomFromInterval(startRange, endRange);
