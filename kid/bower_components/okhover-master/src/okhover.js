...
(function($){
  ...
  $.okhover = function(el, options){
    ...
    base.init = function(){
      ...
      if (!base.options.el) $('body').append('<div id="ok-bg" style="width:100%;height:100%;background-size:cover;background-position:center;z-index:-1;position:fixed;top:0;left:0;"></div>');
